...
const OrdersGridCard = ({ order }) => {
  ...
  const borderColor =
    status === 'delivered' ? COLORS.success : COLORS.in_process;
  ...
  // --- Hover styles ---
  const hoverStyle = hoveredCard
    ? {
        transform: 'translateY(-2px)',
        boxShadow: `0 4px 12px rgba(0,0,0,0.08), 0 0 6px ${borderColor}, 0 0 10px ${borderColor}`,
      }
    : {};

  // Separate border styles to avoid conflicts
  const borderStyle = {
    borderWidth: '2px',
    borderStyle: 'solid',
...
// Works without hover effect (With warning)
// import { useState } from 'react';
// import { COLORS } from '../../constants/colors';
// import { getCategoryName } from '../../constants/categoryMap';
// import { orderGridCardStyles as S } from './OrdersGridCard.styles';
